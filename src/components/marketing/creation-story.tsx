...
import { templateById } from '@/config';
import { cn } from '@/lib/utils';

export function CreationStory() {
  const [activeStep, setActiveStep] = useState<1 | 2 | 3>(1);
  const sampleTemplate = templateById('sunset');
      ...
      <div className="mt-12 grid gap-8 lg:grid-cols-12 lg:items-center">
        ...
        <div className="space-y-4 lg:col-span-5">
          <button
            ...
            className={cn(
              'card w-full p-6 text-left transition-all duration-200',
              activeStep === 1
              ...
              <div className="animate-in fade-in space-y-5 duration-300">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="mt-1 rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-sunken)] px-4 py-2.5 font-medium text-[var(--text-primary)]">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <div className="mt-1 flex items-center gap-2 rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-sunken)] px-3 py-2 text-sm">
                    ...
                    <div>
                      ...
                      <div className="mt-1 flex items-center gap-2 truncate rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-sunken)] px-3 py-2 text-sm">
                  ...
                  <div>
                    ...
                    <div
                      className="relative mt-1 h-20 overflow-hidden rounded-xl p-3 shadow-inner"
                      style={{
                        background: `linear-gradient(135deg, ${sampleTemplate.palette.from}, ${sampleTemplate.palette.to})`,
                      }}
                    >
                      <TemplateSurfaceField
                        surface={sampleTemplate.surface}
                        palette={sampleTemplate.palette}
                        className="size-full"
                      />
                      <span
                        className="relative z-10 font-serif text-sm font-semibold"
                        style={{ color: sampleTemplate.palette.onGradient }}
                      >
                        Sunset Palette · Arcs Surface
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <ul className="divide-y divide-[var(--border-subtle)] rounded-xl border border-[var(--border-subtle)]">
                  ...
                  <li className="flex items-center justify-between p-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-medium">David Ross</span>
                    </div>
            ...
            {activeStep === 3 && (
              <div className="animate-in fade-in space-y-5 duration-300">
                <div className="flex items-center justify-between border-b border-[var(--border-subtle)] pb-4">
                  ...
                  <span className="text-xs text-[var(--text-muted)]">48 Attending</span>
                </div>

                <div className="grid grid-cols-3 gap-3 text-center">
                  <div className="rounded-xl bg-emerald-500/10 p-3">
                    <span className="text-2xl font-bold text-emerald-600">42</span>
                    <p className="text-xs font-medium text-emerald-700">Attending</p>
                  </div>
                  <div className="rounded-xl bg-zinc-500/10 p-3">
                    <span className="text-2xl font-bold text-[var(--text-primary)]">6</span>
